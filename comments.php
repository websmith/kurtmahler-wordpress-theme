	<?php if ( comments_open() ) : ?>
		<div id="respond">
			...
			<form role="form" class="form-horizontal" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
				...
				<p>Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a class="button" href="<?php echo wp_logout_url(get_permalink()); ?>" title="Log out of this account">Log out</a></p>
				<?php else : ?>
